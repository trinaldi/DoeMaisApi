...
namespace DoeMais.Migrations
{
    ...
    [Migration("20250813122253_DonationAddressSnapshot")]
    partial class DonationAddressSnapshot
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("DoeMais.Domain.Entities.Donation", b =>
                {
                    ...
                    b.OwnsOne("DoeMais.Domain.Entities.AddressSnapshot", "AddressSnapshot", b1 =>
                        {
